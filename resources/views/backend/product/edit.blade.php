                        ...
                        <div class="x_content">
                            <form action="{{route('product.update',$product->id)}}" method="post">
                               ...
                               <div class="form-group">
                                    ...
                                    <input type="number" value="{{$product->buy_price}}" class="form-control" id="buy_price" name="buy_price" placeholder="">
                                    <span class="error"><b>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{$product->sell_price}}" class="form-control" id="sell_price" name="sell_price" placeholder="Enter sell_price per Item">
                                    <span class="error"><b>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" value="{{$product->tax}}" class="form-control" id="tax" name="tax" placeholder="Enter tax for Item">
                                    <span class="error"><b>
                                         @if($errors->has('tax'))
                                                {{$errors->first('tax')}}
                                            @endif</b></span>
